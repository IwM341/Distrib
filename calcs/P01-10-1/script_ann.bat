...
..\..\release\annihilation_vector.exe -config config_rd.txt -grid capt/l_grid.txt -ann ann/ann_el.bmat
..\..\release\annihilation_vector.exe -config config_rd.txt -grid capt/h_grid.txt -ann ann/ann_eh.bmat